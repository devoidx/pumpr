      ...
      <div className="about-inner">
        ...
        <div className="about-section">
          ...
          <div className="about-sources">
            <a href={GOV_URL} target="_blank" rel="noopener noreferrer" className="about-source-card">
              ...
              <div>
                ...
                <div className="about-source-desc">
                  Official UK government fuel price data under the Motor Fuel Price (Open Data) Regulations 2025
                </div>
              </div>
            </a>
            <a href="https://openchargemap.org" target="_blank" rel="noopener noreferrer" className="about-source-card">
              <div className="about-source-icon">⚡</div>
              <div>
                <div className="about-source-name">Open Charge Map</div>
                <div className="about-source-desc">
                  Community-maintained global registry of EV charging locations, licensed under Creative Commons
                </div>
              </div>
            </a>
          </div>
        ...
        <div className="about-section">
          ...
          <a href="mailto:hello@pumpr.app" className="about-contact-link">hello@pumpr.app</a>
        </div>
        ...
        <div className="about-section">
          ...
          <p className="about-body about-legal">
            ...
            Prices may be up to 30 minutes old. Always verify prices at the pump before filling up.
            Pumpr is not affiliated with or endorsed by the UK Government, VE3 Global Ltd, or Open Charge Map.
          </p>
