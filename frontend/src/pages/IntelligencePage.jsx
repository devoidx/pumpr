...
const TrendsCharts = lazy(() => import('../components/TrendsCharts'))
    ...
    <div style={{maxWidth:'900px', margin:'0 auto', padding:'24px 16px'}}>
      ...
      {activeTab === 'trends' && <>
        ...
        {trendsData && trendsData.length >= 2 ? <>
          <Suspense fallback={<div style={{height:'220px', display:'flex', alignItems:'center', justifyContent:'center', color:'var(--text3)'}}>Loading charts...</div>}>
